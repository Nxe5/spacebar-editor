...
Local models in the 7B–14B range are the product's core audience but the weakest link in agent quality. Tiny Llama cannot win on raw model intelligence; it must win on **how well it drives weaker models**. This spec covers three improvements:
